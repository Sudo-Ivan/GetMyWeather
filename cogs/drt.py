...
class DRT(commands.Cog):
    ...
    @commands.hybrid_command(description="Get the Distance traveled.")
    ...
    @commands.hybrid_command(description="Get the time to travel the distance.")
    ...
    @commands.hybrid_command(description="Get the rate of travel.")
