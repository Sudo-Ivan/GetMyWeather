...
class Converter(commands.Cog):
    ...
    @commands.hybrid_command()
    async def true_airspeed(self, ctx, altitude: float, indicated_airspeed: float, wind_speed: float, wind_direction: float):
    ...
    @commands.hybrid_command()
    async def ground_speed(self, ctx, altitude: float, indicated_airspeed: float, wind_speed: float, wind_direction: float):
    ...
    @commands.hybrid_command()
    async def wind_component(self, ctx, altitude: float, indicated_airspeed: float, wind_speed: float, wind_direction: float):
    ...
    @commands.hybrid_command()
    async def drift_angle(self, ctx, altitude: float, indicated_airspeed: float, wind_speed: float, wind_direction: float):
    ...
    @commands.hybrid_command()
    async def drift_distance(self, ctx, altitude: float, indicated_airspeed: float, wind_speed: float, wind_direction: float):
    ...
    @commands.hybrid_command()
    async def glide_ratio(self, ctx, altitude: float, indicated_airspeed: float, wind_speed: float, wind_direction: float):
        gr = glide_ratio(altitude, indicated_airspeed, wind_speed, wind_direction)
        await ctx.send(f"Glide ratio at {altitude} m is {gr:.2f}.")

    @commands.hybrid_command()
    async def time_to_altitude(self, ctx, altitude: float, indicated_airspeed: float, wind_speed: float, wind_direction: float):
